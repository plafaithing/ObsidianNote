...
### 随堂测验
- [x] 01-foundations：L01–L04 综合（M1 地基 + M2 数据侧）— 8 题，场景诊断 + 跨环节边界判断
- [x] 02-retrieval：M3 检索侧后加（L05–L07）— 8 题，rerank + 检索侧综合诊断

### 阶段考试（数量适当增加）
- [x] 期中：L06 后，覆盖 L01–L06（20 题，场景诊断 + 跨环节边界 + 选型 + 概念辨析，含计分）— `quizzes/midterm.html`
